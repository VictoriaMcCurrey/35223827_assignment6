...
function introduceTheActors(actorArray){
  actorIntoductions = [];
  actorArray.forEach(function(actors){
    actorIntro = `Hi, I'm ${actors.name} and I was in ${actors.movie}.`;
    actorIntoductions.push(actorIntro)
  })
  return actorIntoductions; 
}
